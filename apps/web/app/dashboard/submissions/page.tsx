      ...
      <div className="p-6">
        {responses?.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20 text-center border-2 border-dashed rounded-xl border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900">
            ...
            <p className="text-gray-500 max-w-md">Once people start filling out your forms, their responses will appear here.</p>
          </div>
        ) : (
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm text-left">
                <thead className="bg-gray-50/50 dark:bg-gray-900/50 border-b text-xs uppercase text-gray-500">
                  <tr>
                    <th className="px-6 py-4 font-semibold w-1/4">Form</th>
                    <th className="px-6 py-4 font-semibold w-1/4">Submitted By</th>
                    <th className="px-6 py-4 font-semibold w-1/4">Date</th>
                    <th className="px-6 py-4 font-semibold w-1/4 text-right">Actions</th>
                  </tr>
                </thead>
