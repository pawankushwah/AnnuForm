...
export default function FormBuilderPage() {
  ...
  const [activeView, setActiveView] = useState<'builder' | 'logic' | 'emails'>('builder');
        ...
        <div className="h-14 border-b bg-white dark:bg-gray-900 flex items-center justify-between px-6 shrink-0 z-10">
          ...
          <div className="flex-1 flex overflow-hidden">
              ...
              <div className="p-4 pb-2 border-b bg-gray-50 dark:bg-gray-950">
                <div className="space-y-1">
                  ...
                  <button
                    ...
                    className={`w-full text-left text-sm px-3 py-2 rounded-md font-medium transition-colors ${activeView === 'emails' ? 'bg-blue-50 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400' : 'text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800'}`}
                  >
                    Emails
                  </button>
                </div>
            ...
            {activeView === 'builder' ? (
              ...
              <EmailSettingsTab formId={id} fields={fields} />
            ) : null}
          </div>
        </div>
    </DndContext>
